...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('expense-master-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
//                'type'=>'raw',		
                'value'=> '$data->rel_expense_expensegroup->expense_group_name',
	          ),
		//'creation_date',
		//'created_by',
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("expenseMaster/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("expenseMaster/update", array("id"=>$data->id))',
