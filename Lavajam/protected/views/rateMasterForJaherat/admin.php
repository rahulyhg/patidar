...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('rate-master-for-jaherat-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Jaherats Rate Details</h1>
<!--
<p>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'rate-master-for-jaherat-grid',
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("rateMasterForJaherat/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("rateMasterForJaherat/update", array("id"=>$data->id))',
