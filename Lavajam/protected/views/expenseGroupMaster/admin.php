...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('expense-group-master-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Expense Group Details</h1>
<!--
<p>
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("expenseGroupMaster/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("expenseGroupMaster/update", array("id"=>$data->id))',
