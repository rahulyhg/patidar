...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('avsan-wise-avak-table-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Avsan Cash Avak Details</h1>
<!--
<p>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		/*array(
		 'name'=>'member_name',
//                'type'=>'raw',		
                'value'=> '$data->Rel_avsanwiseavak_member->member_name',
	          ),*/
		'receipt_date',
		'bill_no_of_avasan',
		//'bill_date_of_avasan',
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("avsanWiseAvakTable/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("avsanWiseAvakTable/update", array("id"=>$data->id))',
