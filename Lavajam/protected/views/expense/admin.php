...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
		 'name'=>'expense_name',
//                'type'=>'raw',		
                'value'=>'$data->rel_expense_expensemaster->expense_name'
	          ),
		//'expense_master_id',
		'expense_amount',
		'expense_date',
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("expense/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("expense/update", array("id"=>$data->id))',
