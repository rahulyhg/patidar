...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'rate_page_no',array('size'=>6,'maxlength'=>5)); ?><span class="status">&nbsp;</span>
		<?php echo $form->error($model,'rate_page_no'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'rate_type_color'); ?>
		<?php //echo $form->textField($model,'rate_type_color'); ?>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'rate_amount',array('size'=>12,'maxlength'=>10)); ?><span class="status">&nbsp;</span>
