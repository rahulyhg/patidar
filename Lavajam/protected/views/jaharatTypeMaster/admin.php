...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('jaharat-type-master-grid', {
		data: $(this).serialize()
	});
	return false;
});
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("jaharatTypeMaster/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("jaharatTypeMaster/update", array("id"=>$data->id))',
