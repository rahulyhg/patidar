...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('avsan-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns'=>array(
		...
		array(
		 'name'=>'member_name',
//                'type'=>'raw',		
                'value'=> '$data->rel_avsan_member->member_name',
	          ),
		'ausan_name',
		'ausan_sender_name',
		...
		array(
		 'name'=>'size',
//                'type'=>'raw',		
                'value'=> '$data->rel_avsan_size->size',
	          ),
		'ausan_total_amount',
		'discount',
		'avsan_net_amount',
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("avsan/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("avsan/update", array("id"=>$data->id))',
