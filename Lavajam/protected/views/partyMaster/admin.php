...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('party-master-grid', {
		data: $(this).serialize()
	});
	return false;
});
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("partyMaster/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("partyMaster/update", array("id"=>$data->id))',
