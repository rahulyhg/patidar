<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('bill_no_of_jaherat')); ?>:</b>
	<?php echo CHtml::encode($data->bill_no_of_jaherat); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('bill_date_of_jaherat')); ?>:</b>
	<?php echo CHtml::encode($data->bill_date_of_jaherat); ?>
	<br />
