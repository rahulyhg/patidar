...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('rate-master-for-avasan-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Avsans Rate Details</h1>
<!--
<p>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'rate-master-for-avasan-grid',
		...
		array(
			...
			'buttons'=>array(
					'view' => array(
						...
						'url'=>'Yii::app()->createUrl("rateMasterForAvasan/view", array("id"=>$data->id))',
					...
					'update' => array(
							...
							'url'=>'Yii::app()->createUrl("rateMasterForAvasan/update", array("id"=>$data->id))',
